...
ALTER TABLE [Topics] ADD [TotalReplies] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [Topics] ADD [TotalViews] int NOT NULL DEFAULT 0;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211103020754_Topic_V1', N'5.0.11');
GO
